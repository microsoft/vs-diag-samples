...
namespace MyShuttle.Client.Desktop.Controls
{
    public partial class Menu : UserControl
    {
        ...
        public static readonly DependencyProperty IsSettingsNavigationEnabledProperty = DependencyProperty.Register("IsSettingsNavigationEnabled", typeof(bool), typeof(Menu), new FrameworkPropertyMetadata(true));
        ...
        public bool IsSettingsNavigationEnabled
        {
            get { return (bool)GetValue(IsSettingsNavigationEnabledProperty); }
            set { SetValue(IsSettingsNavigationEnabledProperty, value); }
        }
