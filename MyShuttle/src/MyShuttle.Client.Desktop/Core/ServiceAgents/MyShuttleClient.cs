...
namespace MyShuttle.Client.Core.ServiceAgents
{
    public class MyShuttleClient : IMyShuttleClient
    {
        ...
        public IVehiclesService VehiclesService
        {
            get
            {
                return _vehiclesService ?? (_vehiclesService = new VehiclesService(_applicationSettingService.VehicleServiceUrlPrefix, _applicationStorageService.SecurityToken));
            }
        }
